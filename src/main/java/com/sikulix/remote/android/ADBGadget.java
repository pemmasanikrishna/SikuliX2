...
public class ADBGadget {
  ...
  public void input(String text) {
    try {
      ...
      SX.pause(text.length() * inputDelay);
    } catch (Exception e) {
      log(-1, "input: %s", e);
    }
  }
