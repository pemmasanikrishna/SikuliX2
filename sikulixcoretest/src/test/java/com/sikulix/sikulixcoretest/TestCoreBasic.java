...
public class TestCoreBasic {
  ...
  public void test_40_startServer() {
    ...
    SX.pause(3);
    Element elem = new Element(300, 300, 500, 500);
    elem.setLastMatch(new Match(new Element(400, 400, 50, 50), 0.92345678, new Element(100, 100)));
    JSONObject jElem = SXJson.makeBean(elem.getElementForJson());
    SXClient.postJSON(jElem.toString());
    SX.pause(1);
    boolean retVal = SXClient.stopServer();
    SX.pause(4);
    result += jElem.toString(2);
    assert retVal;
  }
