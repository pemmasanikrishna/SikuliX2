...
public class Observer11 {
  ...
  protected Observer11(Region region) {
...
//TODO observe changes
  ...
  private void callChangeObserver(List<Mat> results) {
    int n;
    ...
    for (String name : eventNames.keySet()) {
      ...
      for (int i = 0; i < results.size(); i++) {
        Mat mat = results.get(i);
        if (mat.width() * mat.height() >= n) {
